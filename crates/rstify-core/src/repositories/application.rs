...
pub trait ApplicationRepository: Send + Sync {
    async fn create(&self, user_id: i64, name: &str, description: Option<&str>, token: &str, default_priority: i32) -> Result<Application, CoreError>;
    ...
    async fn update(&self, id: i64, name: Option<&str>, description: Option<&str>, default_priority: Option<i32>) -> Result<Application, CoreError>;
